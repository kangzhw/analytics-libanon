...
static unsigned long
anon_uint64_hash_hash(const struct hash_node *tohash) {
	return anon_uint64_hash(tohash);
}
static int
anon_uint64_cmp_cmp(const struct hash_node *arg1, const struct hash_node *arg2) {
	return anon_uint64_cmp(arg1, arg2);
}
#endif
